...
def T1():
    ...
    t1.geometry("400x240")
    t1.config(bg="black")
    l = Label(t1, text="MASS", font="timesnewroman 18 bold",
              bg="black", fg="white").place(x=0, y=0, relwidth=1)
    lst = [" ", "mili gm", "centi gm", "deci gm", "gm", "deca gm",
           "hecto gm", "kilo gm", "pound", "ton", "Quantal"]
    var1 = StringVar()
    var2 = StringVar()
    var3 = StringVar()
    var4 = StringVar()
    ...
    def cal():
        if(var1.get() == "Select" or var3.get() == "Select"):
            ...
            d = {"mili gm": 0.001, "centi gm": 0.01, "deci gm": 0.1, "gm": 1, "deca gm": 10,
                 "hecto gm": 100, "kilo gm": 1000, "pound": 453.59, "ton": 1000000, "Quantal": 100000}
            a = d.get(var1.get())
            b = d.get(var3.get())
    ...
    var1.set("Select")
    e1 = ttk.Entry(t1, textvariable=var2, font="timesnewroman 18 bold").place(
        x=180, y=50, width=200)
    o2 = ttk.OptionMenu(t1, var3, *lst).place(x=5, y=120, width=150, height=40)
    var3.set("Select")
    e1 = ttk.Entry(t1, textvariable=var4, font="timesnewroman 18 bold").place(
        x=180, y=120, width=200)
...
def T2():
    ...
    t2.geometry("400x240")
    t2.config(bg="black")
    l = Label(t2, text="LENGTH", font="timesnewroman 18 bold",
              bg="black", fg="white").place(x=0, y=0, relwidth=1)
    lst = [" ", "mili meter", "centi meter", "deci meter", "meter",
           "deca meter", "hecto meter", "kilo meter", "foot", "inch", "yard"]
    var1 = StringVar()
    var2 = StringVar()
    var3 = StringVar()
    var4 = StringVar()
    ...
    def cal():
        if(var1.get() == "Select" or var3.get() == "Select"):
            ...
            d = {"mili meter": 0.001, "centi meter": 0.01, "deci meter": 0.1, "meter": 1, "deca meter": 10,
                 "hecto meter": 100, "kilo meter": 1000, "foot": 3.28084, "inch": 39.3701, "yard": 1.09361}
            a = d.get(var1.get())
            b = d.get(var3.get())
            var4.set(str(eval(str(eval(var2.get())*(a/b)))))
    ...
    var1.set("Select")
    e1 = ttk.Entry(t2, textvariable=var2, font="timesnewroman 18 bold").place(
        x=180, y=50, width=200)
    o2 = ttk.OptionMenu(t2, var3, *lst).place(x=5, y=120, width=150, height=40)
    var3.set("Select")
    e1 = ttk.Entry(t2, textvariable=var4, font="timesnewroman 18 bold").place(
        x=180, y=120, width=200)
...
def T3():
    ...
    t3.geometry("400x240")
    t3.config(bg="black")
    l = Label(t3, text="TIME", font="timesnewroman 18 bold",
              bg="black", fg="white").place(x=0, y=0, relwidth=1)
    lst = [" ", "milisecond", "second", "minute", "hour",
           "day", "week", "month", "year", "decades"]
    var1 = StringVar()
    var2 = StringVar()
    var3 = StringVar()
    var4 = StringVar()
    ...
    def cal():
        if(var1.get() == "Select" or var3.get() == "Select"):
            ...
            d = {"milisecond": 0.001, "second": 1, "minute": 60, "hour": 3600, "day": 86400,
                 "week": 604800, "month": 2628000, "year": 31557600, "decades": 315360000}
            a = d.get(var1.get())
            b = d.get(var3.get())
            var4.set(str(eval(str(eval(var2.get())*(a/b)))))
    ...
    var1.set("Select")
    e1 = ttk.Entry(t3, textvariable=var2, font="timesnewroman 18 bold").place(
        x=180, y=50, width=200)
    o2 = ttk.OptionMenu(t3, var3, *lst).place(x=5, y=120, width=150, height=40)
    var3.set("Select")
    e1 = ttk.Entry(t3, textvariable=var4, font="timesnewroman 18 bold").place(
        x=180, y=120, width=200)
...
def T4():
    ...
    t4.geometry("400x240")
    t4.config(bg="black")
    l = Label(t4, text="DATA", font="timesnewroman 18 bold",
              bg="black", fg="white").place(x=0, y=0, relwidth=1)
    lst = [" ", "bit", "nibble", "byte", "KB",
    ...
    def cal():
        if(var1.get() == "Select" or var3.get() == "Select"):
            ...
            d = {"bit": 0.0001220703125, "nibble": 0.00048828125, "byte": 0.0009765625, "KB": 1, "MB": 1024, "GB": 1048576, "TB": 1073741824,
                 "PB": 1073741824*(1024**1), "EB": 1073741824*(1024**2), "ZB": 1073741824*(1024**3), "YB": 1073741824*(1024**4)}
            a = d.get(var1.get())
            b = d.get(var3.get())
            var4.set(str(eval(str(eval(var2.get())*(a/b)))))
    ...
    var1.set("Select")
    e1 = ttk.Entry(t4, textvariable=var2, font="timesnewroman 18 bold").place(
        x=180, y=50, width=200)
    o2 = ttk.OptionMenu(t4, var3, *lst).place(x=5, y=120, width=150, height=40)
    var3.set("Select")
    e1 = ttk.Entry(t4, textvariable=var4, font="timesnewroman 18 bold").place(
        x=180, y=120, width=200)
...
def T5():
    ...
    t5.geometry("400x240")
    t5.config(bg="black")
    l = Label(t5, text="DATA", font="timesnewroman 18 bold",
              bg="black", fg="white").place(x=0, y=0, relwidth=1)
    ...
    var1.set("Select")
    e1 = ttk.Entry(t5, textvariable=var2, font="timesnewroman 18 bold").place(
        x=180, y=50, width=200)
    o2 = ttk.OptionMenu(t5, var3, *lst).place(x=5, y=120, width=150, height=40)
    var3.set("Select")
    e1 = ttk.Entry(t5, textvariable=var4, font="timesnewroman 18 bold").place(
        x=180, y=120, width=200)
...
def T6():
    ...
    t6.geometry("400x240")
    t6.config(bg="black")
    l = Label(t6, text="AREA", font="timesnewroman 18 bold",
              bg="black", fg="white").place(x=0, y=0, relwidth=1)
    ...
    def cal():
        if(var1.get() == "Select" or var3.get() == "Select"):
            ...
            d = {"mm2": 10**(-6), "cm2": 10**(-4), "dm2": 10**(-2), "m2": 1,
                 "deca m2": 10**(2), "hecto m2": 10**(4), "Km2": 10**(6)}
            a = d.get(var1.get())
            b = d.get(var3.get())
            var4.set(str(eval(str(eval(var2.get())*(a/b)))))
    ...
    var1.set("Select")
    e1 = ttk.Entry(t6, textvariable=var2, font="timesnewroman 18 bold").place(
        x=180, y=50, width=200)
    o2 = ttk.OptionMenu(t6, var3, *lst).place(x=5, y=120, width=150, height=40)
    var3.set("Select")
    e1 = ttk.Entry(t6, textvariable=var4, font="timesnewroman 18 bold").place(
        x=180, y=120, width=200)
...
def T7():
    ...
    t7.geometry("400x240")
    t7.config(bg="black")
    l = Label(t7, text="VOLUME", font="timesnewroman 18 bold",
              bg="black", fg="white").place(x=0, y=0, relwidth=1)
    ...
    def cal():
        if(var1.get() == "Select" or var3.get() == "Select"):
            ...
            d = {"mm3": 10**(-6), "cm3": 10**(-3), "dm3": 1, "m3": 10**3,
                 "litre": 1, "barrel": 158.987, "gallon": 3.78541, "pint": 0.473}
            a = d.get(var1.get())
            b = d.get(var3.get())
            var4.set(str(eval(str(eval(var2.get())*(a/b)))))
    ...
    var1.set("Select")
    e1 = ttk.Entry(t7, textvariable=var2, font="timesnewroman 18 bold").place(
        x=180, y=50, width=200)
    o2 = ttk.OptionMenu(t7, var3, *lst).place(x=5, y=120, width=150, height=40)
    var3.set("Select")
    e1 = ttk.Entry(t7, textvariable=var4, font="timesnewroman 18 bold").place(
        x=180, y=120, width=200)
...
def T8():
    ...
    t8.geometry("400x240")
    t8.config(bg="black")
    l = Label(t8, text="DATA", font="timesnewroman 18 bold",
              bg="black", fg="white").place(x=0, y=0, relwidth=1)
    ...
    var1.set("Select")
    e1 = ttk.Entry(t8, textvariable=var2, font="timesnewroman 18 bold").place(
        x=180, y=50, width=200)
    o2 = ttk.OptionMenu(t8, var3, *lst).place(x=5, y=120, width=150, height=40)
    var3.set("Select")
    e1 = ttk.Entry(t8, textvariable=var4, font="timesnewroman 18 bold").place(
        x=180, y=120, width=200)
...
def T9():
    ...
    l = Label(t9, text="Discount", font="timesnewroman 18 bold",
              bg="black", fg="white").place(x=0, y=0, relwidth=1)
    l1 = Label(t9, text="Enter value", font="timesnewroman 15").place(
        x=20, y=50, width=150)
    e1 = ttk.Entry(t9, textvariable=var1, font="timesnewroman 15 bold").place(
        x=180, y=50, width=200)
    l2 = Label(t9, text="Enter Discount", font="timesnewroman 15").place(
        x=20, y=90, width=150)
    e2 = ttk.Entry(t9, textvariable=var2, font="timesnewroman 15 bold").place(
        x=180, y=90, width=200)
    l3 = Label(t9, text=" ", fg="white", bg="black",
               font="timesnewroman 15 bold")
    l3.place(x=20, y=170)
    l4 = Label(t9, text=" ", fg="white", bg="black",
               font="timesnewroman 15 bold")
    l4.place(x=20, y=200)
...
l = Label(root, text="Welcome to our Unit Converter Programme".title(
), font="timesnewroman 18 bold", bg="black", fg="white").grid(row=0, columnspan=10)

b = ttk.Button(root, text="Mass", command=T1, width=22).grid(
    row=1, column=0, padx=5, pady=5)
b = ttk.Button(root, text="Length", command=T2, width=22).grid(
    row=1, column=1, padx=5, pady=5)
b = ttk.Button(root, text="Time", command=T3, width=22).grid(
    row=1, column=2, padx=5, pady=5)

b = ttk.Button(root, text="Data", command=T4, width=22).grid(
    row=2, column=0, padx=5, pady=5)
b = ttk.Button(root, text="Temperature", command=T5,
               width=22).grid(row=2, column=1, padx=5, pady=5)
b = ttk.Button(root, text="Area", command=T6, width=22).grid(
    row=2, column=2, padx=5, pady=5)

b = ttk.Button(root, text="Volume", command=T7, width=22).grid(
    row=3, column=0, padx=5, pady=5)
b = ttk.Button(root, text="No. system", command=T8,
               width=22).grid(row=3, column=1, padx=5, pady=5)
b = ttk.Button(root, text="Discount", command=T9, width=22).grid(
